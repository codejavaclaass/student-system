...
public class ADelete1
  extends JFrame
{
  String[][] strs;
  private JButton DReturn;
  private JButton delete;
  private JTextField getstuno1;
  ...
  private void initComponents()
  {
    ...
    this.ok.addActionListener(new ActionListener()
    {
      ...
      {
        ADelete1.this.okActionPerformed(evt);
      }
    });
    ...
    this.delete.addActionListener(new ActionListener()
    {
      public void actionPerformed(ActionEvent evt)
      {
        ADelete1.this.deleteActionPerformed(evt);
      }
    });
    ...
    this.DReturn.addActionListener(new ActionListener()
    {
      public void actionPerformed(ActionEvent evt)
      {
        ADelete1.this.DReturnActionPerformed(evt);
      }
    });
    ...
    layout.setHorizontalGroup(
      ...
      .addComponent(this.getstuno1, -2, 242, -2)
      .addGap(26, 26, 26)
    ...
    layout.setVerticalGroup(
      ...
      .addComponent(this.jLabel1)
      .addComponent(this.getstuno1, -2, 39, -2)
      .addComponent(this.ok))
      .addGap(18, 18, 18)
  ...
  {
    String str = "select * from sims where stuno = '" + this.getstuno1.getText() + "';";
    String[][] strs = Strsselect.select(str);
    new ADelete1(strs).setVisible(true);
    setVisible(false);
  }
  ...
  {
    int yes = JOptionPane.showConfirmDialog(this, "确认删除?", "提示", 0);
    if (yes == 0) {
      Delete.delete(this.getstuno1.getText());
    }
  }
  ...
  public void setGetstuno1(String string)
  {
    this.getstuno1.setText(string);
  }
}
