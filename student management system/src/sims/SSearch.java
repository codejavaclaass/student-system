  ...
  extends JFrame
{
  ...
  private void initComponents()
  {
    ...
    this.Searchname.addActionListener(new ActionListener()
    {
      ...
      {
        SSearch.this.SearchnameActionPerformed(evt);
      }
    });
    ...
    this.SearchBut.addActionListener(new ActionListener()
    {
      public void actionPerformed(ActionEvent evt)
      {
        SSearch.this.SearchButActionPerformed(evt);
      }
    });
    ...
    this.Reset.addActionListener(new ActionListener()
    {
      public void actionPerformed(ActionEvent evt)
      {
        SSearch.this.ResetActionPerformed(evt);
      }
    });
    ...
    this.ASearchReturn.addActionListener(new ActionListener()
    {
      public void actionPerformed(ActionEvent evt)
      {
        SSearch.this.ASearchReturnActionPerformed(evt);
      }
    });
    this.Searchstuno.addActionListener(new ActionListener()
    {
      public void actionPerformed(ActionEvent evt)
      {
        SSearch.this.SearchstunoActionPerformed(evt);
      }
    });
  ...
  public static void main(String[] args)
  {
    ...
    {
      Logger.getLogger(SSearch.class.getName()).log(Level.SEVERE, null, ex);
    }
